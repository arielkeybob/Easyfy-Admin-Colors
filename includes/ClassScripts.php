...
class ClassScripts {
    ...
    public function enqueue_styles_and_scripts() {
        wp_enqueue_style('easyfy-admin-colors-css', plugin_dir_url(__FILE__) . '../admin/css/admin.css', array(), '1.0', 'all');
        ...
        if ($apply_scheme) {
            wp_enqueue_script('easyfy-live-preview', plugin_dir_url(__FILE__) . '../admin/js/live-preview.js', array('jquery', 'wp-color-picker'), '1.0', true);
